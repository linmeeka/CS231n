...
def rnn_backward(dh, cache):
    ...
    for t in range(T-1,-1,-1):#reverse
        ...
        db+=db_t
    dh0=dprev_h
    dx=np.array(dx[::-1]).transpose(1,0,2)#reverse
    ##############################################################################
    #                               END OF YOUR CODE                             #
    ##############################################################################
...
def lstm_step_forward(x, prev_h, prev_c, Wx, Wh, b):
    ...
    cache=[a,i,f,o,g,prev_c,prev_h,next_c,next_h,Wx,Wh,x]
    ##############################################################################
    #                               END OF YOUR CODE                             #
    ##############################################################################
...
def lstm_step_backward(dnext_h, dnext_c, cache):
    ...
    #############################################################################
    a,i,f,o,g,prev_c,prev_h,next_c,next_h,Wx,Wh,x=cache
